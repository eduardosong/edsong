        ...
        return (
            <React.Fragment>
                ...
                <div className="greeting">
                    <span className='title animated fadeIn'><strong>Hey!</strong></span>
                    <span className='title animated fadeIn name'><strong>Eduardo Song</strong></span>
                    <span className='title animated fadeIn'><strong>here.</strong></span>
                </div>
                <div className="navigation">
                    <div className='site-nav'>
                        <ul className='animated fadeInUpSmall delay-025s'>
                            <li className='nav-item link-start'><button className='link resume-btn' onClick={this.openResume}>View Resume</button></li>
                        </ul>
                    </div>
